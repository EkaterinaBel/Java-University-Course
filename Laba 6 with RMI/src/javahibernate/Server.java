            ...
            while (!Thread.currentThread().isInterrupted()) {
                ...
                if (bol) {
                    ...
                    if (mapContainsChanges.size() != 0) {
                        ...
                        int portForRegistry = 8181;
                        oos.writeObject(portForRegistry);
                        FilesToTheClient service = new SelectFilesToTheClient();
                        Registry reg = LocateRegistry.createRegistry(portForRegistry);
                        String serviceName = "SelectFilesToTheClient";
